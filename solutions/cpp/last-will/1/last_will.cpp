...
namespace estate_executor{
    ...
    {
        int account_number{zhang::bank_number_part(secret_modifier)+khan::bank_number_part(secret_modifier)+garcia::bank_number_part(secret_modifier)};
    ...
    int assemble_code()
    {
        int blue_sum{zhang::blue::code_fragment()+khan::blue::code_fragment()+garcia::blue::code_fragment()};
        int red_sum{zhang::red::code_fragment()+khan::red::code_fragment()+garcia::red::code_fragment()};
        int code{blue_sum*red_sum};
        return code;
    }
}